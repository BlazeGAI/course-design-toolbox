...
st.sidebar.write(
    """This application extracts the content from each activity in the course into an HTML file."""
)
...
def main():
    ...
    if submit_button:
        ...
        # Create the Session before calling the login function
        ...
        combined_html = (
            ...
            f"<h1>Extracted Activities for Course {course_id}</h1>\n"
        )
