...
ALLOWED_USERNAMES = ["mckay", "mckaym","meadowsml", "schmalleggerd", "raavis", "testabcd"]
...
def main():
    ...
    if submit_button:
        ...
        for path in course_paths:
            ...
            # If we get a 200 status, assume we have the correct path
